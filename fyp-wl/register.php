									...
									<div class="field dob">
										...
										<div class="day-input">
											<label class="label">
												Day											</label>
											<div class="control">
											<input id="dob_day" name="dob_day" type='number' class="input" min="1" placeholder="DD" value="" pattern="[0-9] " />
											</div>
										...
										<div class="year-input">
											<label class="label ">
												Year											</label>
											<div class="control">
											<input id="dob_year" name="dob_year" type='number' class="input" min="1869" placeholder="YYYY" value="" pattern="[0-9]" />
											</div>
