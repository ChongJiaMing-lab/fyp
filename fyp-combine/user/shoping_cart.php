...
<?php include"head.php"?>
   ...
   ?>
							...
							<div class="my-checkout-listing">
										...
										<div class="column is-10">
											<div class="columns is-mobile">
												...
												<!-- UNIT PRICE -->
												<div class="column is-3 product-price">RM<?php echo $row ['price'] ?></div>
    ...
    <div class="product-delete">
        <a href="Remove(cart).php?id=<?php echo $row['product_id']; ?>" class="remove btn-del icon-delete"></a>
    </div>
</div>
					...
					<div class="my-order-summary-list">
						...
						<!-- SUBTOTAL + TOTAL -->					
							...
							<form id="coupon-form" action="..." method="post" enctype="multipart/form-data">
										...
										<div class="control">
											<input type="text" id="coupon" name="coupon" placeholder="Coupon Code" class="input coupon-code" value="">
										</div>
										<div class="control">
											<button id="btn_apply_coupon" type="button" class="button btn-coupon btn-default">
												Apply											</button>
										</div>
									</div>
															</form>
