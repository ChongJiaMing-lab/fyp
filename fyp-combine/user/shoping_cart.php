...
<head>
    ...
    <!-- MAIN STYLESHEET -->
    <link defer href="https://techzone.com.my/catalog/view/theme/aio/stylesheet/aio.css?ver=1712902977" rel="stylesheet" type="text/css" />
    ...
    <!-- CUSTOMIZE -->
    <link defer id="customize_css" href="https://techzone.com.my/catalog/view/multi_store/techzone/aio_customize_css.css?ver=1712902977" rel="stylesheet" type="text/css" />
                                        ...
                                        <div class="my-checkout-listing">
                                            <div class="columns is-mobile ">
                                                ...
                                                <div class="column is-2 product-image">
                                                    <a href=".."><img class="img-responsive" src="../image/<?php echo $row1['image'] ?>" /></a>
                                                </div>
                                                ...
                                                <div class="column is-10">
                                                    <div class="columns is-mobile">
                                                        <div class="column is-5 product-info">
                                                            ...
                                                            <!-- PRODUCT NAME -->
                                                            <a class="product-name" href=""><?php echo $row1['product_name'] ?></a>
                                                            <!-- VARIATIONS -->
                                                        </div>
                                                        ...
                                                        <div class="column is-4 product-quantity">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" id="quantity_0" name="quantity[<?php echo $row1['cart_id']; ?>]" class="input-quantity" value="<?php echo $row1['qty'] ?>" min="1" max="999999" data-stock="<?php echo $row1['stock']; ?>">
                                                            ...
                                                            <div class="product-delete">
                                                                <a href="Remove(cart).php?id=<?php echo $row1['product_id']; ?>" class="remove btn-del icon-delete"></a>
                                                            </div>
                                                        </div>
                        ...
                        <div class="my-order-summary-list">
                            ...
                            <form id="coupon-form" action="..." method="post" enctype="multipart/form-data">
                                <div class="field has-addons">
                                    <div class="control">
                                        <input type="text" id="vouncher-code" name='voucher_code' placeholder="Coupon Code" class="input coupon-code" value="" readonly>
                                    </div>
                                    <div class="control">

                                        <button id="btn_apply_coupon" type="button" class="button btn-coupon btn-default" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            Apply </button>
                                        <div class="modal fade v" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
