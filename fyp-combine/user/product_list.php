            ...
            <div class="holder">
                ...
                <div class="module-container">
                    ...
                    <style>
                        ...
                        #contents #sidebar-left .module-container .box .box-content,
                        #contents #sidebar-right .module-container .box .box-content,
                        #contents #sidebar-left .module-container .box .box-content a,
                        #contents #sidebar-right .module-container .box .box-content a {
                            font-size: 14px;
                            padding: 20px;
                        }
